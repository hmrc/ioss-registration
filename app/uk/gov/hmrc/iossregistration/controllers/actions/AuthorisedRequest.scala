...
case class AuthorisedRequest[A](request: Request[A], credentials: Credentials, userId: String, vrn: Option[Vrn], iossNumber: Option[String], intermediaryNumber: Option[String]) extends WrappedRequest[A](request)
